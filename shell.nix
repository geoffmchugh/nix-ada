...
pkgs.mkShell {
  nativeBuildInputs = [ pkgs.gnat pkgs.alire nix-ada.alire-index nix-ada.gtkada pkgs.gprbuild nix-ada.aws nix-ada.gnat_util nix-ada.gnat-gdb-scripts nix-ada.gnatstudio ];
